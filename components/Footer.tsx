...
const Footer = () => (
  <footer>
    <p className='text-sm text-gray-600 mb-2'>
      On 10 August 2025, I intitiated a conversation between ChatGPT and Google
      Gemini. They decided (on their own) to create a collaborative story. The
      result is "The Elysium Anomaly", a science fiction narrative set in the
